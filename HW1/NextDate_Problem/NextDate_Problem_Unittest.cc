...
TEST(Solve_Triangle_Problem, RobustBoundaryTest) {
  // Test in robust boundary value form.
	EXPECT_STREQ("Invalid Input", Solve_Triangle_Problem(100, 100, 0));
	EXPECT_STREQ("Invalid Input", Solve_Triangle_Problem(100, 100, 201));
	EXPECT_STREQ("Invalid Input", Solve_Triangle_Problem(0, 100, 100));
	EXPECT_STREQ("Invalid Input", Solve_Triangle_Problem(201, 100, 100));
	EXPECT_STREQ("Invalid Input", Solve_Triangle_Problem(100, 0, 100));
	EXPECT_STREQ("Invalid Input", Solve_Triangle_Problem(100, 201, 100));
}
...
TEST(Solve_Triangle_Problem, WeakRobustEquivalenceTest) {
  // Test in weak robust equivalence class form.
	EXPECT_STREQ("Invalid Input", Solve_Triangle_Problem(-1, 5, 5));
	EXPECT_STREQ("Invalid Input", Solve_Triangle_Problem(5, -1, 5));
	EXPECT_STREQ("Invalid Input", Solve_Triangle_Problem(5, 5, -1));
	EXPECT_STREQ("Invalid Input", Solve_Triangle_Problem(201, 5, 5));
	EXPECT_STREQ("Invalid Input", Solve_Triangle_Problem(5, 201, 5));
	EXPECT_STREQ("Invalid Input", Solve_Triangle_Problem(5, 5, 201));
}
...
TEST(Solve_Triangle_Problem, StrongRobustEquivalenceTest) {
  // Test in strong robust equivalence class form.
	...
	EXPECT_STREQ("Invalid Input", Solve_Triangle_Problem(5, -1, 5));
	EXPECT_STREQ("Invalid Input", Solve_Triangle_Problem(5, 5, -1));
	EXPECT_STREQ("Invalid Input", Solve_Triangle_Problem(-1, -1, 5));
	EXPECT_STREQ("Invalid Input", Solve_Triangle_Problem(5, -1, -1));
	EXPECT_STREQ("Invalid Input", Solve_Triangle_Problem(-1, 5, -1));
	EXPECT_STREQ("Invalid Input", Solve_Triangle_Problem(-1, -1, -1));
}
